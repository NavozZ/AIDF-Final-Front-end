...
function Navigation() {
  ...
  return (
    <nav className="z-50 fixed top-0 left-0 w-full bg-cover bg-center bg-fixed bg-gradient-to-t from-black/50 to-transparent text-white py-4 px-6 sm:px-8 flex flex-col items-center justify-between shadow-xl transition-all duration-300">
      {/* Top Row: EN, Logo, Log In, Sign Up */}
      <div className="flex items-center justify-between w-full mb-4">
        {/* EN Button on the Left */}
      ...
      {/* Second Line: Navbar Items (Home, Book Hotel, etc.) */}
      <div className="flex justify-center space-x-20 mb-2 w-full">
        <a href="/" className="text-sm hover:text-gray-200 transition-colors">
          Home
        </a>
        <a href="/book-hotel" className="text-sm hover:text-gray-200 transition-colors">
          Book Hotel
        </a>
        <a href="/destinations" className="text-sm hover:text-gray-200 transition-colors">
          Destinations
        </a>
          ...
          >
            <div className="flex flex-col space-y-4 py-2">
              ...
              <Button
                variant="ghost"
                size="sm"
                className="justify-start h-8 px-3 text-sm font-medium"
              >
              ...
              <Button
                size="sm"
                className="bg-white text-black hover:bg-gray-200 w-full mt-3"
                asChild
                onClick={() => setIsMenuOpen(false)}
              >
                <a href="/sign-up">Sign Up</a>
