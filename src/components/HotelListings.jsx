...
function HotelListings() {
  ...
  const { data: hotels, isLoading: isHotelsLoading, isError: isHotelsError } =
  ...
  if (isError) {
    return (
      <section className="container mx-auto py-12 px-4 text-center">
        <h2 className="text-2xl font-bold mb-2 text-destructive">Failed to Load Hotels</h2>
  ...
  return (
    <section className="container mx-auto py-12 px-4">
      ...
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-2xl font-bold">Filter by Location</h3>
      ...
      {filteredHotels?.length === 0 ? (
        <div className="text-center py-16 border-2 border-dashed border-border rounded-xl">
          ...
          <p className="text-muted-foreground">Try selecting "All" or a different location.</p>
        </div>
      ) : (
